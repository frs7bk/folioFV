    ...
    try:
        ...
        data = {
            ...
            'item': {
                ...
                # إضافة بيانات الفيديو - تأكد من وجود الفيديو للتحقق من تفعيل الزر
                'video_type': item.video_type if item.video_type else '',
                'video_url': item.video_url if item.video_url else '',
                'video_file': item.video_file if item.video_file else '',
                'video_thumbnail': item.video_thumbnail if item.video_thumbnail else '',
                'has_video': bool(item.video_type and (item.video_url or item.video_file))
            }
        }
